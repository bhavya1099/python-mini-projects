...
from alarm_clock.alarm_clock import Threading  # Ensure the directory is named 'alarm_clock'
from threading import Thread

@pytest.mark.usefixtures("mock_alarm_function")
class TestAlarmClockThreading:  # Removed underscore from class name for consistency

    @pytest.fixture
    def mock_alarm_function(self):
        with patch('alarm_clock.alarm_clock.alarm') as mock_alarm:  # Ensure the patch path matches the module
            yield mock_alarm
